...
The final complete-cohort and copied-baseline K1-carryover TeX tables are
generated by `serverTest/build_stage_c_publication_tables.py`; the manuscript
inputs those generated fragments instead of duplicating their numerical rows.
