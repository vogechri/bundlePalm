...
CAMERA_UPDATE=${CAMERA_UPDATE:-se3_left}
SCHUR_PCG_MAX_ITERATIONS=${SCHUR_PCG_MAX_ITERATIONS:-400}
CAMERA_DIAGONAL_METRIC_SCALE=${CAMERA_DIAGONAL_METRIC_SCALE:-25}
SO3_TRANSLATION_METRIC_RATIO=${SO3_TRANSLATION_METRIC_RATIO:-1}
INITIAL_TRUST_REGION_RADIUS=${INITIAL_TRUST_REGION_RADIUS:-10}
MAXIMUM_TRUST_REGION_RADIUS=${MAXIMUM_TRUST_REGION_RADIUS:-1000000}
DABA_INITIAL_TRUST_REGION_CAP=${DABA_INITIAL_TRUST_REGION_CAP:-100}
...
run_case() {
  ...
  env \
    ...
    BUNDLE_PALM_SO3_TRANSLATION_METRIC_RATIO="$SO3_TRANSLATION_METRIC_RATIO" \
    BUNDLE_PALM_INITIAL_TRUST_REGION_RADIUS="$INITIAL_TRUST_REGION_RADIUS" \
    BUNDLE_PALM_MAXIMUM_TRUST_REGION_RADIUS="$MAXIMUM_TRUST_REGION_RADIUS" \
    BUNDLE_PALM_DABA_INITIAL_TRUST_REGION_CAP="$DABA_INITIAL_TRUST_REGION_CAP" \
