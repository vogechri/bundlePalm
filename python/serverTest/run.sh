#BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=32 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=2 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.01 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/final/ problem-3068-310854-pre.txt.bz2 90 30 2> lm3068_drs.txt # slow but main problem
...
#PYTHONPATH=build/generated/proto BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=32 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=2 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.01 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 BUNDLE_PALM_MAX_REFINEMENT_PASSES=1 BUNDLE_PALM_BATCH_REPAIR_SCANS=1 BUNDLE_PALM_PARTITION_TRACE=1 .venv/bin/python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/final/ problem-961-187103-pre.txt.bz2 5 30 2> lm961_drs.txt
...
#Bounded repairs: faster, but may leave more weak camera-cluster incidences.
#BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=32 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=2 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.01 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 BUNDLE_PALM_MAX_REFINEMENT_PASSES=1 BUNDLE_PALM_BATCH_REPAIR_SCANS=1 python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/final/ problem-871-527480-pre.txt.bz2 90 30 2> lm871_bounded.txt
#Periodic restart compromise: restart after 32 accepted repairs, then polish with a second pass.
#BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=32 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=4 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.03 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/final/ problem-871-527480-pre.txt.bz2 90 30 2> lm871_k32.txt
BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=32 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=2 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.01 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/venice/ problem-1778-993923-pre.txt.bz2 90 30 2> lm1778_drs.txt
BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=32 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=2 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.01 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/venice/ problem-1490-935273-pre.txt.bz2 90 30 2> lm1490_drs.txt

# TEST:
BUNDLE_PALM_MAX_REFINEMENT_PASSES=2 BUNDLE_PALM_REPAIR_RESTART_INTERVAL=8 BUNDLE_PALM_HARD_GROUP_MAX_CAMERAS=2 BUNDLE_PALM_CLUSTERING=landmark_clean BUNDLE_PALM_RESIDUAL_BALANCE_SLACK=0.01 BUNDLE_PALM_MIN_CAMERA_LANDMARKS=20 python -u client_acc.py http://grail.cs.washington.edu/projects/bal/data/final/ problem-394-100368-pre.txt.bz2 0 30
