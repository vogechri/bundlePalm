...
OUTPUT_ROOT=${OUTPUT_ROOT:-"$WORKSPACE/benchmark_results/stage_c_c5_low_development_k24_i30"}
...
THRESHOLDS=${THRESHOLDS:-"0.10 0.15 0.20"}
OVERWRITE=${OVERWRITE:-0}
REQUEST_PORT=${REQUEST_PORT:-32420}
...
for threshold in $THRESHOLDS; do
  ...
  C5_HIGH_THRESHOLD="$HIGH_THRESHOLD" C5_LOW_THRESHOLD="$threshold" \
...
echo "Stage-C C5 low-threshold sweep finished: $OUTPUT_ROOT"