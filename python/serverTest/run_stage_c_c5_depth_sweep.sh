...
OUTPUT_ROOT=${OUTPUT_ROOT:-"$WORKSPACE/benchmark_results/stage_c_c5_depth_development_k24_i30"}
...
REQUEST_PORT=${REQUEST_PORT:-33020}
...
for value in $VALUES; do
  ...
  C5_WINDOW="$WINDOW" C5_DWELL="$DWELL" C5_MAXIMUM_DEPTH="$value" \
...
echo "Stage-C C5 maximum-depth sweep finished: $OUTPUT_ROOT"