...
OUTPUT_ROOT=${OUTPUT_ROOT:-"$WORKSPACE/benchmark_results/stage_c_c5_window_development_k24_i30"}
...
REQUEST_PORT=${REQUEST_PORT:-32620}
...
echo "Stage-C C5 window sweep finished: $OUTPUT_ROOT"