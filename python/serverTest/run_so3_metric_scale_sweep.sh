...
ANALYZER="$SCRIPT_DIR/analyze_so3_metric_scale_sweep.py"
PYTHON=${PYTHON:-"$SCRIPT_DIR/.venv/bin/python"}
OUTPUT_ROOT=${OUTPUT_ROOT:-"$WORKSPACE/benchmark_results/so3_metric_scale_development_k24_i30"}
...
VALUES=${VALUES:-"10 25 50 75"}
ITERATIONS=${ITERATIONS:-30}
REQUEST_PORT=${REQUEST_PORT:-63020}
...
for value in $VALUES; do
  ...
  CAMERA_DIAGONAL_METRIC_SCALE="$value" C5_START_ITERATION=5 \
...
echo "SO3 metric-scale sweep finished: $OUTPUT_ROOT"
