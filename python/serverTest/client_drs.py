...
def main():
    ...
    if (
        ...
        raise ValueError(
            "two-step Schur residual oracle requires a proposal iteration"
        )
    if (
        arguments.two_step_schur_residual_oracle
    ...
    try:
        ...
        for iteration in range(arguments.iterations):
            ...
            if schur_alignment_tangent is not None:
                ...
                one_step_schur_alignment = (
                    diagonal_weighted_tangent_alignment(
                        schur_alignment_tangent[shared_cameras],
                        one_step_schur_tangent[shared_cameras],
                        schur_alignment_diagonal[shared_cameras],
                    )
                )
                one_step_schur_model = evaluate_global_schur_direction(
                    schur_alignment_systems,
                    camera_count,
                    arguments.schur_alignment_camera_damping,
                    one_step_schur_tangent,
