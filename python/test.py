...
print("Starting post_process_cluster_lib")
# test post process cluster, trying to reduce caemras with few landmarks observations in cluster, potentially leading to underconstrained cams. 
res_to_cluster_by_landmark_, _, _ = \
