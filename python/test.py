...
def cluster_covis_lib(kClusters, camera_indices__, point_indices__):
    ...
    print(" cluster_covis done ")
    print("lib.vector_sizes(res_toadd_sizes_out, i) ", 0, " : ", lib.vector_size(res_to_cluster_c_out))
    print("lib.vector_get(res_toadd_sizes_out, i) ", 0, " : ", lib.vector_get(res_to_cluster_c_out, 0))
