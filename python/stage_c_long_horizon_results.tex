...
thread per cluster; Ceres is left-$\mathrm{SE}(3)$ at I90/T16.  Timings are
reported within their named CPU boundary, not as matched work comparisons.
...
retain that speed while recovering the longer-horizon base trajectory.
