...
from clustering import cluster_deg_by_landmark, init_lib
#import pyinstrument
...
def bundle_adjust(
    point_indices_, # fit to observations / residuals
    camera_indices_,
    poses_only_in_cluster_, # those cameras should be excluded from prox part. But those cams do not exist (would be much faster)
    torch_points_2d, # 2d residuals
    points_3d_in,
    cameras_in,
...
def prox_f(camera_indices_in_cluster_, point_indices_in_cluster_, local_camera_indices_in_cluster_, local_landmark_indices_in_cluster_,
    ...
    for ci_ in range(kClusters):
        (
            ...
            local_camera_indices_in_cluster_[ci], # unused
